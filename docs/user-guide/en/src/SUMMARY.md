...
- [Settings center](settings.md)
- [Remote workspaces and SSH](remote-workspaces.md)
...
- [Agent and CLI configuration](agent-configuration.md)
- [Skill management](skill-management.md)
- [MCP servers](mcp.md)
- [Prompt Hooks](prompt-hooks.md)
- [Local extensions](extensions.md)
...
- [Permission approvals](permissions.md)
- [Observability](observability.md)
- [Scheduled tasks and notifications](scheduled-tasks.md)
