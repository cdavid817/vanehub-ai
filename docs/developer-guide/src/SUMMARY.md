...
# Orientation and runtime boundaries
...
- [Persistence ownership](persistence-ownership.md)
...
# Workspaces and platform capabilities

- [SSH connections and the remote runtime](ssh-connections.md)
- [Local media runtime](local-media-runtime.md)
...
# Engineering delivery and qualification

- [OpenSpec workflow](openspec-workflow.md)
- [Testing](testing.md)
- [Release](release.md)
- [Multi-Agent group chat acceptance](multi-agent-acceptance.md)
