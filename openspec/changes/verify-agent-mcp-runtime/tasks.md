...
- [x] 4.5 Preserve cross-platform desktop teardown by closing the WebDriver session before the delayed test-only application exit and waiting for the native clean-shutdown marker.
