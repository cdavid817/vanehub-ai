...
- [x] 10.5 Run applicable desktop permission/Claude hook flows with fixed fixtures, record each actually tested operating system as PASSED/FAILED/BLOCKED/NOT RUN, and do not infer untested platform results.
