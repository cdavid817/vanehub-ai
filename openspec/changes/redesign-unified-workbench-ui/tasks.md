...
- [ ] 4.14 Add one-time localized "moved to Runs/Plan/Quality" hints for users entering through a legacy route; store only a versioned dismissal flag. — Blocked on 4.5: there is nothing to hint about until legacy routes actually redirect somewhere instead of silently falling back to Sessions.
