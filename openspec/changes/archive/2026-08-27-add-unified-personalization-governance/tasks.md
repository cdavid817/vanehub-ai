...
- [x] 14.8 Run the repository's desktop WebdriverIO/Tauri tests for native IPC, persistence, restart, migration, session mode, and 201+/1,000-memory reset scenarios on supported platforms.
...
- [x] 14.13 Run `cargo test --workspace`.
