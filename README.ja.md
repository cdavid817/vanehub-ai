...
- [ ] プロジェクト License を確認し、`LICENSE` ファイルを追加する。
...
リポジトリ内に `LICENSE` ファイルまたは license フィールドは見つかりませんでした。公開配布または再配布の前に、プロジェクトのライセンス確認が必要です。
