...
/// Contiguous through 73. Migration 53 reconciles Plan execution and workspace code indexing,
...
/// Skill configuration records, and migration 73 adds revision-bound Skill tool trust,
