...
/// Contiguous through 66. Migration 53 reconciles Plan execution and workspace code indexing,
...
/// migration 66 adds the privacy-bounded Skill evolution evidence store.
