...
fn valid_planner_output_is_strictly_parsed_validated_and_persisted() {
    ...
    let application = service(
        ...
        Ok(PlanGenerationResponse {
            ...
            content: r#"{
                "discovery":{"status":"degraded","limitations":["language intelligence unavailable"]},
                "executionPolicy":{
                ...
                "subtasks":[{
                    ...
                    "validationCommands":[{"id":"tests","program":"cargo","args":["test"],"workingDirectory":null,"timeoutSeconds":300,"required":true}]
                }],
                "dependencies":[]
            }"#
            .to_string(),
