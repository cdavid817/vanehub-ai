...
use crate::contexts::agent_runtime::application::{
    ...
    ContextAnalysisInput, ContextAnalysisService, ContextEngineService, ContextQualityRecorder,
    ...
    NativeToolResultStatus, ProcessStopInitiator, SaveMemoryInput, SkillToolUseProvenance,
    StartedGenerationProcess, StoredToolOperation, StoredToolOperationStatus, ToolApprovalDecision,
    ToolApprovalPort, ToolEligibilityContext, ToolLifecycleEvent, ToolLifecyclePhase, ToolUseBlock,
    UtilityDelegationApplicationService, WorkflowLaunchOutcome, WorkflowLaunchRequest,
    ASK_USER_QUESTION_TOOL_NAME, DELEGATE_UTILITY_SKILL_TOOL_NAME, EXIT_PLAN_MODE_TOOL_NAME,
    ...
    LIST_SKILLS_TOOL_NAME, LOAD_SKILL_TOOL_NAME, READ_SKILL_RESOURCE_TOOL_NAME, REMEMBER_TOOL_NAME,
};
use crate::contexts::agent_runtime::domain::{
    AutomaticCompactionState, ContextCapacity, MemoryType, UsageAnchor, UtilityDelegationLimits,
...
use compaction::{maybe_compact_accounted, should_compact, turns_character_count};
use generation::{
    generation_options_from_configuration, is_plan_mode, reviewed_stream_usage_strategy,
    run_generation,
};
use interactive::{
    ask_user_question, await_approval, permission_action_and_resource, plan_mode_denial,
    request_plan_exit, ApprovalOutcome,
};
use invocation::{
...
use crate::contexts::agent_runtime::application::{
    ...
    tool_catalog, AgentChatConfiguration, AgentMemory, AgentMemorySelectionPort, BoundSkillPrompt,
    PersonalizationSettings, ToolDefinition, EDIT_TOOL_NAME, GLOB_TOOL_NAME, GREP_TOOL_NAME,
    INTERFACE_FORMAT_OPENAI_COMPATIBLE, MAX_PLAN_CHARS, MAX_QUESTION_CHARS, MAX_QUESTION_OPTIONS,
    MAX_QUESTION_OPTION_CHARS, MCP_TOOL_NAME_PREFIX, MIN_QUESTION_OPTIONS, NOTEBOOK_TOOL_NAME,
    RECALL_TOOL_NAME, SEARCH_CODE_TOOL_NAME, SHELL_KILL_TOOL_NAME, SHELL_OUTPUT_TOOL_NAME,
    SHELL_TOOL_NAME, TODO_WRITE_TOOL_NAME,
};
#[cfg(test)]
use crate::contexts::agent_runtime::domain::{
    ContextAssessmentOutcome, ContextAssessmentPath, ContextAssessmentReason,
    ContextCompactionEvidence, ContextQualityAssessmentRecord,
};
#[cfg(test)]
use crate::contexts::permissions::domain::{Action, Resource};
#[cfg(test)]
use crate::contexts::skill_evolution_evidence::domain::{
    OperationClass, SafeCounts, SkillAssociationKind,
};
#[cfg(test)]
use compaction::{
    compaction_notice_block, compatibility_compact_accounted, run_automatic_compaction,
    AutomaticCompactionOutcome,
};
#[cfg(test)]
use generation::{extract_memories_accounted, project_native_outcomes};
#[cfg(test)]
use interactive::validate_question_input;
#[cfg(test)]
