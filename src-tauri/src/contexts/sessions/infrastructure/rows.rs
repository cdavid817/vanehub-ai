...
impl SessionRow {
    pub(super) fn read(row: &Row<'_>) -> rusqlite::Result<Self> {
        Ok(Self {
            ...
            personalization_mode: row.get(38)?,
        })
    }
    ...
    pub(super) fn into_record(self) -> Result<SessionRecord, SessionsApplicationError> {
        ...
        Ok(SessionRecord {
            ...
            personalization_mode: SessionPersonalizationMode::parse(&self.personalization_mode)?,
