...
const checkedFiles = [
  ...
  "src/settings/pages/prompt-hooks/prompt-hook-detail-sections.tsx",
  ...
  "src/settings/pages/prompt-hooks/prompt-hook-version-history.tsx",
  ...
  "src/loop-center/loop-verification-command-editor.tsx",
