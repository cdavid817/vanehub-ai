...
export interface MissionControlCounts {
  running: number; waitingApproval: number; waitingUser: number; retrying: number;
  blocked: number; failed: number; completedRecently: number;
}
...
export interface MissionControlRunSummary {
  runId: string; version: number; ownerType: string; ownerId: string; agentId: string | null;
  title: string; state: AgentRunState; createdAt: string; updatedAt: string; endedAt: string | null;
  projectId: string | null; workspace: string | null; phase: string | null;
  attention: MissionControlAttention | null; reasonCode: string | null;
...
export interface MissionControlOverview {
  counts: MissionControlCounts; attention: MissionControlPage; active: MissionControlPage; recent: MissionControlPage;
}
