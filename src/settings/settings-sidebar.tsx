...
export function SettingsSidebar({ activePageId, onSelectPage }: SettingsSidebarProps) {
  ...
  return (
    <aside className="ucd-panel flex min-h-0 flex-col rounded-lg p-2 max-lg:overflow-x-auto">
      ...
      <nav className="grid gap-1 border-t border-border pt-2 max-lg:flex max-lg:w-max max-lg:border-t-0 max-lg:pt-0">
