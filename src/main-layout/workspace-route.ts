export type WorkspaceDestination = "sessions" | "plans" | "loops" | "work-board" | "goals" | "evaluations";

export const workspaceDestinations: WorkspaceDestination[] = ["sessions", "plans", "loops", "work-board", "goals", "evaluations"];
