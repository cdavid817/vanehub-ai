...
export interface MissionControlQuery { cursor?: string | null; limit?: number; states?: AgentRunState[]; agentId?: string; projectId?: string; runner?: "local" | "remote"; sort?: MissionControlSort }
